<template>
  <div style="display: flex;">
    <sidenav-manage v-if="isMounted" @updateList="getOrganizations" :organizations="organizations" style="max-width: 300px; min-width: 300px; height: 100vh; background-color: #EEEEEE;"></sidenav-manage>
