<template>
  <div style="display: flex; height: calc(100vh - 80px);">
    <sidenav-manage v-if="isMounted" @updateList="getOrganizations" :organizations="organizations" style="max-width: 300px; min-width: 300px; height: 100%; background-color: #EEEEEE;"></sidenav-manage>
