<template>
  <div style="display: flex; flex-direction: column; justify-content: space-between;">
    <div>
      ...
      <form novalidate class="flex-input-container" @submit.prevent="updatePwd" style="display: flex; flex-wrap: wrap;">
        <md-field :class="getValidationClass('password')" class="input-container" style="width: 300px; margin-right: 20px;">
